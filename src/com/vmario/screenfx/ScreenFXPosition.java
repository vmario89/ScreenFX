 ...
 * 
 */
enum ScreenFXPosition {
	LEFT_TOP, MIDDLE_TOP, RIGHT_TOP, LEFT_MIDDLE, MIDDLE_MIDDLE, RIGHT_MIDDLE, LEFT_BOTTOM, MIDDLE_BOTTOM, RIGHT_BOTTOM, RESIZE_HEIGHT, RESIZE_WIDTH, FULLSCREEN;
}